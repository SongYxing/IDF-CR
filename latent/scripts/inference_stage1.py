...
# python scripts/inference_stage1.py --config configs/model/swinir.yaml --ckpt lightning_logs/lightning_logs/version_3/checkpoints/step=19999.ckpt --input /home/abc/SongFlies/GRSL/dataset/RICE_DATASET_div/RICE1/test/cloudy_image --sr_scale 1 --image_size 512 --output /home/abc/SongFlies/GRSL/dataset/toMe/swinir
