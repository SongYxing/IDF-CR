...
# python scripts/make_stage2_init_weight.py --cldm_config configs/model/cldm.yaml --sd_weight /home/abc/SongFlies/GRSL/huggingface/v2-1_512-ema-pruned.ckpt --swinir_weight weights/general_full_v1.ckpt --output weights/init_Weight/init_Weight_1.ckpt
