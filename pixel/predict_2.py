...
from data_manager_2 import TestDataset
from utils import gpu_manage, save_image, heatmap
from models.gen.SPANet_2 import Generator
...
def predict(config, args):
    ...
    with torch.no_grad():
        for i, batch in enumerate(tqdm(data_loader)):
            ...
            save_image(args.out_dir, a.transpose(1, 2, 0), i, 1, filename=filename)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--config', type=str, default='config_2.yml')
...
# python predict.py --config config.yml --test_dir data/RICE_DATASET/RICE1 --out_dir data/output/try1 --pretrained pretrained_models/RICE1/gen_model_epoch_200.pth --cuda
